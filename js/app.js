...
{
    fetch('http://localhost/MiLocalCAC24145/api/api.php', 
        {
        method: 'POST',
        headers: {
...
function loadItems() {
  ...
  {
    fetch(`http://localhost/MiLocalCAC24145/api/api.php?id=${id}`, 
        {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
...
function updateItem(data) 
    {
        fetch(`http://localhost/MiLocalCAC24145/api/api.php?id=${data.id}`, 
            {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
